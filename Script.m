...
linPosHP_1000 = 1000.* linPosHP;
%data_to_save = [time, linPosHP_1000]; %% time stamp included
writematrix(["X (m)", "Y (m)", "Z (m)"; linPosHP_1000], 'linear_position.csv');
%writematrix(["Time (s)", "X (m)", "Y (m)", "Z (m)"; data_to_save], 'linear_position.csv');